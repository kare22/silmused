...
class Translator():
    def __init__(self, translations_folder='silmused\locale', file_format='json', default_locale='en'):
        # initialization
        #self.data = {}
        self.data = data
        self.locale = 'et'
        ...
        """if file_format in supported_format:
            ...
            #print(os.path.join(path,translations_folder, f'*.{file_format}'))
            print(files)
            for fil in files:
