...
class TestTriggerTestFeedback:
    ...
    def test_trigger_definition_negative_feedback(self, mock_cursor):
        ...
        result = test.run(mock_cursor)
        assert result['is_success'] is False
        assert result['message']['test_key'] == 'trigger_definition_manipulation_negative_feedback'
        assert 'trg_users_updated' in result['message']['params']['trigger_name']
        assert 'UPDATE' in result['message']['params']['manipulation']
    ...
    def test_trigger_definition_negative_feedback_missing_timing(self, mock_cursor):
        ...
        result = test.run(mock_cursor)
        assert result['is_success'] is False
        assert result['message']['test_key'] == 'trigger_definition_action_timing_negative_feedback'
        assert 'trg_users_updated' in result['message']['params']['trigger_name']
    ...
    def test_trigger_definition_negative_feedback_multiple_errors(self, mock_cursor):
        ...
        assert result['message']['test_key'] == 'trigger_definition_manipulation_negative_feedback'
        assert 'trg_users_updated' in result['message']['params']['trigger_name']
        # UPDATE error is before action_timing
        assert 'UPDATE' in result['message']['params']['manipulation']
